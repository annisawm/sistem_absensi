                                    ...
                                    <form action="{{ route('guest.update', $guest->id) }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('nip', $guest->nip) }}" placeholder="Masukkan NIP">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="nama" value="{{ old('nama', $guest->nama) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="jenis_kelamin"
                                                value="{{ old('jenis_kelamin', $guest->jenis_kelamin) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="nama_instansi"
                                                value="{{ old('nama_instansi', $guest->nama_instansi) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="jabatan" value="{{ old('jabatan', $guest->jabatan) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="no_hp" value="{{ old('no_hp', $guest->no_hp) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                value="{{ old('ttd', $guest->ttd) }}" placeholder="Masukkan TTD">
